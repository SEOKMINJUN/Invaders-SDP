...
public class AchievementList {
    ...
    @Getter private static final Achievement ACHIEVEMENT_KILLSTREAKS_5   = (new Achievement("Gunslinger", "Kill streak of 5", 5, AchievementType.KILLSTREAKS, 1));
    @Getter private static final Achievement ACHIEVEMENT_KILLSTREAKS_15   = (new Achievement("Fear the Enemy", "Kill streak of 15", 15, AchievementType.KILLSTREAKS, 5));
    @Getter private static final Achievement ACHIEVEMENT_KILLSTREAKS_30   = (new Achievement("Genocide","Kill streak of 30", 30, AchievementType.KILLSTREAKS, 10));

    @Getter private static final Achievement ACHIEVEMENT_ACCURACY_60     = (new Achievement("Preheating","Accuracy of 60%", 60, AchievementType.ACCURACY,5));
    @Getter private static final Achievement ACHIEVEMENT_ACCURACY_75     = (new Achievement("Overheating","Accuracy of 75%", 75, AchievementType.ACCURACY, 5));
    @Getter private static final Achievement ACHIEVEMENT_ACCURACY_85     = (new Achievement("Runaway","Accuracy of 85%", 85, AchievementType.ACCURACY, 5));
