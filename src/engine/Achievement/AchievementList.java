...
public class AchievementList {
    ...
    @Getter private static final Achievement ACHIEVEMENT_KILLSTREAKS_5   = (new Achievement("Gunslinger", "Kill streak of 3", 5, AchievementType.KILLSTREAKS, 1));
    @Getter private static final Achievement ACHIEVEMENT_KILLSTREAKS_15   = (new Achievement("Fear the Enemy", "Kill streak of 5", 15, AchievementType.KILLSTREAKS, 5));
    @Getter private static final Achievement ACHIEVEMENT_KILLSTREAKS_30   = (new Achievement("Genocide","Kill streak of 7", 30, AchievementType.KILLSTREAKS, 10));
